...
![image-20220310124548418](C:\Users\15630\AppData\Roaming\Typora\typora-user-images\image-20220310124548418.png)
...
[力扣链接](https://leetcode-cn.com/problems/unique-paths-ii/) 
...
![image-20220314230223332](C:\Users\15630\AppData\Roaming\Typora\typora-user-images\image-20220314230223332.png)

![image-20220314230204415](C:\Users\15630\AppData\Roaming\Typora\typora-user-images\image-20220314230204415.png)
...
![image-20220315152026099](C:\Users\15630\AppData\Roaming\Typora\typora-user-images\image-20220315152026099.png)
...
[力扣](https://leetcode.cn/problems/reordered-power-of-2/)
...
public int reverse(int x) {
    int prev = 0;
    while(x != 0){
        if(prev < Integer.MIN_VALUE / 10 || prev > Integer.MAX_VALUE / 10){
            return 0;
        }
        int ge = x % 10;
        x /=10;
...
![image-20220807171804669](代码随想录/image-20220807171804669.png)
